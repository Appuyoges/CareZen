...
<head>
    ...
    <link rel="icon" href="logo_A.jpeg">
    ...
    <!-- ################# Header Starts Here#######################--->
      ...
      <header id="menu-jk">
        ...
        <div id="nav-head" class="header-nav">
            <div class="container">
                <div class="row">
                    <div class="col-lg-2 col-md-3  col-sm-12" style="color: #004999 ;font-weight:bold; font-size:30px; margin-top: 1% !important;">CuriousFreaks
        ...
        <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner">
                <div class="carousel-item ">
                    <img class="d-block w-100" src="assets/images/slider/slider_02.jpg" alt="Second slide">
                    <div class="carousel-cover"></div>
                    <div class="carousel-caption vdg-cur d-none d-md-block">
                    <h5 style="color:white;" class="animated bounceInUp">REC Health</h5>
                ...
                <div class="carousel-item active">
                    <img class="d-block w-100" src="assets/images/slider/slider_03.jpg" alt="Third slide">
                      <div class="carousel-cover"></div>
                    <div class="carousel-caption vdg-cur d-none d-md-block">
                    <h5 style="color:white;" class="animated bounceInDown">We're Known For Outstanding Care </h5>
                ...
                <div class="row no-margin">
                    <div class="col-sm-4 blog-smk">
                        <div class="blog-single">
                                ...
                                <img src="assets/images/patient_A.jpg" alt="">
                    ...
                    <div class="col-sm-4 blog-smk">
                        <div class="blog-single">
                                ...
                                <img src="assets/images/doctor_A.jpg" alt="">
                    ...
                    <div class="col-sm-4 blog-smk">
                        <div class="blog-single">
                                ...
                                <img src="assets/images/admin_A.jpg" alt="">
...
?>
    ...
    <p><?php  echo $row['PageDescription'];?>.</p><?php } ?>
        ...
        <br/>
            ...
            <div class="gallery_product col-lg-4 col-md-4 col-sm-4 col-xs-6 filter hdpe">
                <img src="assets/images/gallery/gallery_A.jpg" class="img-responsive">
            </div>

            <div class="gallery_product col-lg-4 col-md-4 col-sm-4 col-xs-6 filter sprinkle">
                <img src="assets/images/gallery/gallery_B.jpg" class="img-responsive">
            </div>

            <div class="gallery_product col-lg-4 col-md-4 col-sm-4 col-xs-6 filter hdpe">
                <img src="assets/images/gallery/gallery_C.jpg" class="img-responsive">
            </div>

            <div class="gallery_product col-lg-4 col-md-4 col-sm-4 col-xs-6 filter irrigation">
                <img src="assets/images/gallery/gallery_D.jpg" class="img-responsive">
            </div>

            <div class="gallery_product col-lg-4 col-md-4 col-sm-4 col-xs-6 filter spray">
                <img src="assets/images/gallery/gallery_E.jpg" class="img-responsive">
            </div>

          

            <div class="gallery_product col-lg-4 col-md-4 col-sm-4 col-xs-6 filter spray">
                <img src="assets/images/gallery/gallery_F.jpg" class="img-responsive">
            </div>
    ...
    <br>
        <!-- ######## Gallery End ####### -->
        <div><center>
            <h3>Hello! If you're experiencing any symptoms and would like to learn more or receive a diagnosis, please click the below button to be redirected to our diagnosis web page.</h3></center>
</div>
<script>
    function handleKeyPress(event) {
        ...
        if (event.keyCode === 39) {
            ...
            window.location.href = '../../HMS/hospital/hms/video.html';
        }
    }
</script>

<center>
    <button onclick="window.location.href='../../HMS/hospital/hms/video.html'" onkeypress="handleKeyPress(event)" style="background-color: lightgreen;">
        <h3>Diagnose Now</h3>
        <b></b>
    </button>
</center>
...
?>
    ...
    <div class="copy">
            <div class="container">
         REC Health <h2>CuriousFreaks</h2>
