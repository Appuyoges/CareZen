...
{ ?>
	...
	<a href="appointment-history.php?id=<?php echo $row['id']?>&cancel=update" onClick="return confirm('Are you sure you want to approve this appointment ?')"class="btn btn-transparent btn-xs tooltips" title="approve Appointment" tooltip-placement="top" tooltip="Remove">Approve</a>
	<?php } else {
